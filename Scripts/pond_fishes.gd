...
@onready var fish_sprite: AnimatedSprite2D = $Pond_Fishes_Sprites

const FISH_DATA = [
	{"name": "Bluegill", "rarity": "Common",    "multiplier": 1.1},  
	{"name": "Goldfish", "rarity": "Common",    "multiplier": 1.1}, 
	{"name": "Standard Sturgeon",  "rarity": "Rare",  "multiplier": 1.2},
	{"name": "Butterfly Koi",      "rarity": "Epic",      "multiplier": 1.5}, 
	{"name": "Beluga Sturgeon",    "rarity": "Legendary",      "multiplier": 2.5},  
	{"name": "Abella",      "rarity": "Legendary", "multiplier": 2.5},  
]
