...
@onready var fish_sprite: AnimatedSprite2D = $Ocean_Fishes_Sprites

const FISH_DATA = [
	{"name": "Sardine",           "rarity": "Common",    "multiplier": 1.1},  # frame 0
	{"name": "Mackerel",          "rarity": "Common",    "multiplier": 1.1},  # frame 1
	{"name": "Red Snapper",       "rarity": "Rare",      "multiplier": 1.2},  # frame 2
	{"name": "Swordfish",         "rarity": "Epic",      "multiplier": 1.5},  # frame 3
	{"name": "Great White Shark", "rarity": "Legendary", "multiplier": 2.5},  # frame 4
